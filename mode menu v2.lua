...
-- Speed Hack Module for LogdrinosMenuV3 (додати в кінець вашого скрипта)
do
    -- Додаємо фрейм для Speed Hack
    ...
    -- Поле для швидкості (невидиме до правої кнопки)
    ...
    -- При появі нового персонажа
    player.CharacterAdded:Connect(function(character)
        humanoid = character:WaitForChild("Humanoid")
        updateSpeed()
    end)

    -- Розширення меню під новий блок
